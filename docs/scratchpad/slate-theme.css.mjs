...
.ds-content>.ds-block+.ds-section{margin-top:44px}
...
/* ============================================================
   ...
   ============================================================ */
.ds-tablewrap{border:1px solid var(--ds-line-2);border-radius:11px;overflow:hidden}
...
/* ============================================================
   ...
   ============================================================ */
.ds-release-gate{display:grid;gap:9px}
.ds-release-list .ds-action{flex-wrap:wrap;align-items:flex-start;gap:10px}
.ds-release-list .ds-action label{flex:1 1 auto}
.ds-release-list .ds-action-meta{flex-wrap:wrap}
