...
@media (hover:hover){
  .ds-card:hover{transform:translateY(-1px);box-shadow:var(--ds-elev-2);transition-duration:var(--ds-t-fast)}
}
...
/* verdict/selected state is carried by the tinted head + status badge — no colored edge ring */
